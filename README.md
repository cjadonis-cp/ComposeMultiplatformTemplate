...
|---------|----------|----------|
| **Pure MVI** | `core.mvi.pure.BaseViewModel` | Simple screens (counters, forms, detail views) |
| **MVI with Reducer** | `core.mvi.reducer.BaseViewModel` | Medium complexity (search, filters, validated forms) |
| **MVI with State Machine** | `core.mvi.statemachine.BaseViewModel` | Multi-step workflows (checkout, onboarding, auth) |
...
│   │   ├── pure/             # Pure MVI BaseViewModel
│   │   ├── reducer/          # MVI with Reducer BaseViewModel
│   │   └── statemachine/     # MVI with State Machine BaseViewModel
